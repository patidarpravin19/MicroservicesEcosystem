...
public sealed class Role : AggregateRoot, ITenantEntity
{
    ...
    public void RevokePermission(string permissionCode)
    {
        if (IsSystemDefined)
        {
            throw new IdentityDomainException($"Role '{Name}' is system-defined and cannot be modified.");
        }
    ...
    public void Delete()
    {
        if (IsSystemDefined)
        {
            throw new IdentityDomainException($"Role '{Name}' is system-defined and cannot be deleted.");
        }
    ...
    private static string NormalizePermissionCode(string permissionCode)
    {
        ...
        {
            throw new IdentityDomainException("Permission code cannot be empty.");
        }

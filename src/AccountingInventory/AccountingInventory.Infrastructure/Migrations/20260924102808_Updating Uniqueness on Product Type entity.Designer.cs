...
namespace AccountingInventory.Infrastructure.Migrations.AccountingInventoryDb
{
    ...
    [Migration("20260924102808_Updating Uniqueness on Product Type entity")]
    partial class UpdatingUniquenessonProductTypeentity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AccountingInventory.Domain.Entities.ProductType", b =>
                {
                    ...
                    b.HasIndex("VendorId", "BrandId", "Name")
                        .IsUnique()
                        .HasDatabaseName("ix_product_types_vendor_id_brand_id_name");
